...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			var branchuser="<%=session.getAttribute("branchuser")%>"
		</script>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/skin/js/branchjob.js"></script>
	...
	<body class="container">
	    ...
	    <div class="btn-group pull-right" style="margin-top:-25px;margin-right:20px; font-size: 20px;">
		    <div class="user-info" style="color:blue;">
		    	<span class="glyphicon glyphicon-user" ></span>
		        <span class="user-role"><%=session.getAttribute("branchuser")%></span>
		     </div>
		</div>
		<div>
